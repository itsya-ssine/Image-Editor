...
app = ctk.CTk()
app.title("Developed by @0x_naoki")
ctk.set_appearance_mode(mode)
...
# Add the logo
logo_img = Image.open(resource_path("icons\\logo.png"))
...
img_open = ctk.CTkImage(light_image=Image.open(resource_path("icons\\img.png")), 
                        dark_image=Image.open(resource_path("icons\\img.png")), 
                        size=(20, 20))
...
img_save = ctk.CTkImage(light_image=Image.open(resource_path("icons\\save.png")),
                        dark_image=Image.open(resource_path("icons\\save.png")),
                        size=(18, 18))
...
for i in range(len(icons)):
    icon = Image.open(resource_path(icons[i])).resize((30, 30), Image.LANCZOS)
